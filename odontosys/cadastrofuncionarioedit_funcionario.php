...
if (! is_array($usuario)) {
    ...
    echo "javascript:window.location='usuarioscadastrados_funcionario.php';</script>";
    exit();
}
?>
<!DOCTYPE html>
	...
	<div class="wrapper">
		...
		<nav
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block"><a
					href="suportetecnico_funcionario.php" class="nav-link">Contato Suporte</a></li>
			</ul>
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="index.php" class="brand-link">
                <img src="dist/img/perfilOdonto.png" alt="OdontoSys Logo" class="brand-image img-circle elevation-3" style="opacity: .8"> <span
			...
			<div class="sidebar">
				...
				<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
					...
					<li class="nav-item"><a href="registrar_login_funcionario.php" class="nav-link">
		...
		<div class="content-wrapper">
			...
			<section class="content">
				<form action="edit_funcionario_funcionario.php" method="POST">
					<div class="container-fluid">
						<div class="row">
							<div class="col-md-6">
