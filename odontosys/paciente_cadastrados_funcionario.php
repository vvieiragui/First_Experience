      ...
      <div class="input-group input-group-lg ">  
        <div class="input-group-prepend ">
          ...
          <ul class="dropdown-menu">
            <li class="dropdown-item"><a href="cadastropaciente_funcionario.php">Cadastro Paciente</a></li>
          </ul>
        </div>
      </div>
      <!-- /btn-group -->
                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><th scope="col">
                      <a href="cadastropacienteedit_funcionario.php?id=<?php echo $usuario['id'] ?>"><i class="far fa-edit"  style = "font-size:25px"></i></a></th>
                      <th scope="col">
                      <a href="delete_paciente_funcionario.php?id=<?php echo $usuario['id'] ?>" onclick="return confirm('Tem certeza de que deseja remover?');"><i class="fas fa-trash-alt" style = "font-size:25px"></i></a></th>
                      </td>
                    </tr>
                    <?php endwhile; ?>
                  </tbody>
