...
<body class="hold-transition sidebar-mini">
	<div class="wrapper">
		...
		<nav class="main-header navbar navbar-expand navbar-white navbar-light">
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block">
					<a href="suportetecnico_funcionario.php" class="nav-link">Contato Suporte</a></li>
			</ul>
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			<!-- Logo -->
			<a href="indexfuncionario.php" class="brand-link"> <img
		...
		<div class="content-wrapper">
			...
			<section class="content">
				<form action="add_funcionario_funcionario.php" name="cadastrofuncionario" method="POST">
					<div class="container-fluid">
						<div class="row">
							<div class="col-md-6">
								<div class="card card-primary">
									...
									<div class="card-body">
										...
										<div class="form-group">
											<label for="telefone">T	elefone</label> <input type="text" class="form-control" id="telefone" name="telefone" placeholder="(00) 90000-0000">
										</div>
